  ...
  useFocusEffect(
    useCallback(() => {
      ...
      const getPearls = async () => {
        ...
        console.log("Fetched pearls for user:", allPearls);
  ...
  return (
    ...
    >
      <View style={localStyles.headerContainer}>
        ...
        />
        <Text style={localStyles.headerTextName}>{username}</Text>
      ...
      <View style={localStyles.middleContainer}>
        ...
        <Button
          ...
          path="./settings"
          buttonStyle={globalStyles.formButton}
          buttonTextStyle={globalStyles.formButtonText}
        />
      </View>
      <View style={localStyles.postsContainer}>
        <Text style={localStyles.postsTitle}>Mine innlegg</Text>
        <PearlList
